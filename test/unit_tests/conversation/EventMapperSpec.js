...
describe('Event Mapper', () => {
  ...
  describe('mapJsonEvent', () => {
    it('maps text messages without link previews', done => {
    ...
    it('maps text messages with deprecated link preview format', done => {
      const event_id = z.util.createRandomUuid;
    ...
    it('maps text messages with link preview', done => {
      const event_id = z.util.createRandomUuid;
    ...
    it('skips messages which cannot be mapped', done => {
      // prettier-ignore
      /* eslint-disable comma-spacing, key-spacing, sort-keys, quotes */
  ...
  describe('_mapAssetImage', () => {
    it('detects a malformed asset key', () => {
      ...
      const asset_et = event_mapper._mapAssetImage(event, true);
